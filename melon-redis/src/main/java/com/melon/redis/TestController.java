...
public class TestController {
    ...
    @GetMapping("rs/setString")
    public String rsSetString() {
        redissonClient.<String>getBucket("number").set("111", 5, TimeUnit.HOURS);
        return "success";
    }

    @GetMapping("rs/getString")
    public String rsGetString() {
        return redissonClient.<String>getBucket("number").get();
    }
